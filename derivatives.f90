...
public ddx, ddy, ddxy, filt_da, ddz_uv, ddz_w, ddx_fd, ddy_fd
...
!*******************************************************************************
subroutine ddx_fd(f, dfdx)
!*******************************************************************************
!
! This is a subroutine for the derivative in x-direction using finite difference
! This is only for a 2D array 
!
use types, only : rprec
use param, only : nx, ny, dx
implicit none

real(rprec), dimension(:,:), intent(in) :: f
real(rprec), dimension(:,:), intent(inout) :: dfdx
real(rprec)::const
integer :: jx, jy
...
do jy = 1, ny
do jx = 1, nx-1
    dfdx(jx,jy) = const*(f(jx+1,jy)-f(jx,jy))
end do
end do


end subroutine ddx_fd

!*******************************************************************************
subroutine ddy_fd(f, dfdy)
!*******************************************************************************
!
! This is a subroutine for the derivative in y-direction using finite difference
! This is only for a 2D array 
!
use types, only : rprec
use param, only : nx, ny, dy
implicit none

real(rprec), dimension(:,:), intent(in) :: f
real(rprec), dimension(:,:), intent(inout) :: dfdy
real(rprec)::const
integer :: jx, jy
...
do jy = 1, ny-1
do jx = 1, nx
    dfdy(jx,jy) = const*(f(jx,jy+1)-f(jx,jy))
end do
end do


end subroutine ddy_fd
